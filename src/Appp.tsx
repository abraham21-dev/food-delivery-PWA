...
const Header = ({ i18n, onSelectRestaurant, onBackHome, cartCount }: any) => {
    ...
    <header className="bg-white/80 backdrop-blur-xl sticky top-0 z-[100] px-4 py-3 flex items-center justify-between border-b border-gray-100">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative">
          ...
          <button onClick={() => setActivePopup(activePopup === 'restaurants' ? null : 'restaurants')} className="px-4 py-2 bg-gray-900 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-orange-500 transition-all shadow-md">
          ...
          {activePopup === 'restaurants' && (
            ...
            <div className="fixed inset-x-4 top-16 md:absolute md:inset-auto md:right-0 md:top-12 w-auto md:w-72 bg-white rounded-3xl shadow-2xl border border-gray-100 p-4 animate-in slide-in-from-top-2 duration-200">
              ...
              <div className="space-y-1 max-h-64 overflow-y-auto pr-1">
                ...
                {filteredRes.map((res) => (
                  ...
                  <button key={res.name} onClick={() => { onSelectRestaurant(res.name); setActivePopup(null); }} className="w-full text-left p-3 hover:bg-orange-50 rounded-2xl flex items-center justify-between group">

                    <div>

                      <p className="text-sm font-black group-hover:text-orange-500 transition-colors">{res.name}</p>
        ...
        <div className="relative">
          ...
          <button className="w-9 h-9 rounded-xl border border-gray-100 flex items-center justify-center text-lg hover:bg-gray-50 transition-all">
